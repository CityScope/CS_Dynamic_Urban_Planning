...
global{
	...
	file<geometry> busStops_shapefile <- file<geometry>("./../includes/City/volpe/kendall_busStop.shp");
	file<geometry> TStops_shapefile <- file<geometry>("./../includes/City/volpe/kendall_TStops.shp");
	file<geometry> entry_point_shapefile <- file<geometry>("./../includes/City/volpe/kendall_entry_points.shp");
	file<geometry> Tline_shapefile <- file<geometry>("./../includes/City/volpe/kendall_Tline.shp");
	file<geometry> roads_kendall_shapefile <- file<geometry>("./../includes/City/volpe/Roads.shp");
	...
	file calibratedCase <- file("../results/MLResultsCalibratedData.csv");
	file diversityIncentive <- file("../results/MLResultsDiversityIncentive.csv");
	file kendallFancyIncentive <- file("../results/MLResultsKendallFancyIncentive.csv");
	file envFriendlyIncentive <- file("../results/MLResultsEnvFriendlyIncentive.csv");
	file diversityKendallFancyIncentive <- file("../results/MLResultsDiversityKendallFancyIncentive.csv");
	file diversityEnvFriendlyIncentive <- file("../results/MLResultsDiversityEnvFriendlyIncentive.csv");
	file kendallFancyEnvFriendlyIncentive <- file("../results/MLResultsEnvFriendlyKendallFancyIncentive.csv");
	file diversityKendallFancyEnvFriendlyIncentive <- file("../results/MLResultsEnvFriendlyKendallFancyDiversityIncentive.csv");
	
	
	file activity_file <- file("../includes/Criteria/ActivityPerProfile.csv");
	file originalProfiles <- file("../includes/Criteria/Profiles.csv");
	file mode_file <- file("../includes/Criteria/Modes.csv");
