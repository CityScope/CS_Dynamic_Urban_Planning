...
global{
	...
	file criteria_home_file <- file("./../includes/Criteria/CriteriaHome.csv"); //home preference parameters f(income profile). Starting points will be taken from here
	...
	file criteria_file <- file("../includes/Criteria/CriteriaFile.csv"); //synthetic criteria file for mobility preferences
	...
	file real_Kendall_data_file <- file("../includes/City/censusDataGreaterBoston/kendallWorkersCleaned.csv"); //census block groups where people working in the area of interest live (this data is only available for a small propotion of them, it will be extrapolated to the whoel amount of workers, once their preference criteria is identified)
	file real_mobility_data_file <- file("../includes/Criteria/realKendallMobility.csv"); //transportation data 
